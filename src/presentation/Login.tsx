    ...
    return (
        <section>
            ...
            <div className="container h-full p-10">
                <div
                    className="g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 light:text-neutral-200">
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <div className="mb-12 pb-1 pt-1 text-center">
                                                <button
                                                    ...
                                                    style={{
                                                        background:
                                                            "linear-gradient(to right, #00594E,rgb(97, 124, 40), #B5A160)",
                                                    }}
                                                >
                                                    Iniciar Sesion
                                                </button>
